...
public class GameCardsetStage extends Stage {
	...
	public GameCardsetStage(Learn2Quiz game) {
		myGame = game;
		...
		SimpleButtonScript btnOK = SimpleButtonScript.selfInit(mySceneLoader.getRoot().getCompositeById("btnOK"));
